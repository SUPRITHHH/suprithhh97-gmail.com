...
var fruits2 = [123,'PINEAPPLE',true];

console.log(fruits2[0]);
console.log(fruits2[1]);
console.log(fruits2[3]);

var fruits3 = [123,'PINEAPPLE',true,null];
...
var fruits5 = ["Mango",25,true,null,undefined];
...
console.log(fruits5[5]);
console.log(fruits5[6]);
console.log(fruits5[7]);
console.log(fruits5[8]);
console.log(fruits5[9]);
